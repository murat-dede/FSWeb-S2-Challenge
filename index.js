...
function paragrafOlustur(cumleDizisi, callbackCumleKur, callbackCumlelereDonustur) {
	let yeniDizi = callbackCumlelereDonustur(cumleler, " ");
	let paragraf = callbackCumleKur(yeniDizi[1], yeniDizi[3], yeniDizi[5], yeniDizi[7],)
	return paragraf;
}
...
for (const [key,value] of Object.entries(emojilerNesnesi))
}
